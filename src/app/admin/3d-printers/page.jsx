...
const CACHE_KEY = "products_3d_printers";
const CACHE_DURATION = 5 * 60 * 1000; // 5 minutes
const CACHE_METADATA_KEY = "cache_metadata_3d_printers";
const SEARCH_CACHE_KEY = "search_history_3d_printers";
const USER_PREFS_KEY = "user_prefs_3d_printers";
...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      ...
      setLoading(true);
      try {
        const res = await axios.get("/api/products/category/3D%20Printers");
  ...
  const handleExportCache = () => {
    try {
      ...
      a.href = url;
      a.download = `3d-printers-cache-${Date.now()}.json`;
      a.click();
