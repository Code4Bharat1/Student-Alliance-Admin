...
const CACHE_KEY = "products_ops";
const CACHE_DURATION = 5 * 60 * 1000; // 5 minutes
const CACHE_METADATA_KEY = "cache_metadata_ops";
const SEARCH_CACHE_KEY = "search_history_ops";
const USER_PREFS_KEY = "user_prefs_ops";
...
export default function Admin() {
    ...
    const fetchProducts = async () => {
      ...
      try {
        const res = await axios.get(
          "https://api-studentalliance.nexcorealliance.com/api/products/category/OPS"
        );
  ...
  const handleExportCache = () => {
    try {
      ...
      a.href = url;
      a.download = `ops-cache-${Date.now()}.json`;
      a.click();
          ...
          <div className="relative p-6 bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row gap-4 mb-6">
                <div className="relative flex-1">
                  <input
                    type="text"
                    placeholder="Search OPS products..."
                    value={searchTerm}
            ...
            {loading && products.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="mt-4 text-gray-600 font-medium">Loading OPS products...</p>
              </div>
            )}
            ...
            {filteredProducts.length === 0 && !loading && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 font-medium">
                  {searchTerm ? "No OPS products match your search" : "No OPS products found"}
                </p>
              </div>
            )}
