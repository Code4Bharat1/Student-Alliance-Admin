...
const CACHE_KEY = "products_stem_robotics";
const CACHE_DURATION = 5 * 60 * 1000; // 5 minutes
const CACHE_METADATA_KEY = "cache_metadata_stem_robotics";
const SEARCH_CACHE_KEY = "search_history_stem_robotics";
const USER_PREFS_KEY = "user_prefs_stem_robotics";
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row gap-4 mb-6">
                <div className="relative flex-1">
                  <input
                    type="text"
                    placeholder="Search STEM & Robotics products..."
                    value={searchTerm}
